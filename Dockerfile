...
# RUN pip install git+https://github.com/PermafrostDiscoveryGateway/viz-staging
# RUN pip install git+https://github.com/PermafrostDiscoveryGateway/viz-raster/tree/main
